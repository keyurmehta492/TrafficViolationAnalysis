...
Data_projection = FOREACH Dataset GENERATE Arrest_Type;
Data_distinct = DISTINCT Data_projection;
STORE Data_distinct INTO 's3://bigdataproj590/output/Arrest_Type';
