...
VehicleType_projection = FOREACH Dataset GENERATE Alcohol, VehicleType;
VehicleType_group = GROUP VehicleType_projection BY (VehicleType, Alcohol);
result= FOREACH VehicleType_group GENERATE group.VehicleType, group.Alcohol, COUNT(VehicleType_projection);
STORE result INTO 's3://bigdataproj590/output/VehicleType_Alcohol_Wise';
