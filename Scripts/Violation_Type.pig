...
ViolationType_projection = FOREACH Dataset GENERATE Violation_Type;
ViolationType_group = GROUP ViolationType_projection BY Violation_Type;
result= FOREACH ViolationType_group GENERATE group, COUNT(ViolationType_projection);
STORE result INTO 's3://bigdataproj590/output/Violation_Type_Wise';
